...
// The live movement atlas has a hard integrity boundary: zero/zero is a
// sentinel, not a geographic position, and an offline vehicle's stored
// latitude/longitude is not a live observation. Sanitize at the transport
// boundary so every existing atlas consumer inherits the invariant.
