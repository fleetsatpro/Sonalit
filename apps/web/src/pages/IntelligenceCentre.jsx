...
export default function IntelligenceCentre(){
 ...
 return <div className="sonalit-intelligence-shell">
  ...
  <div className="ic-module-context"><span><Radio size={12}/> DATA FABRIC</span><i/><span>DEEP WORKSPACES</span><i/><span>30s CORE REFRESH</span><i/><span>FAIL-CLOSED SCOPING</span></div>
