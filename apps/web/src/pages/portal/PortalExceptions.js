...
function ExceptionRow({ exc }) {
    ...
    return (<div className={`flex items-start gap-4 px-5 py-4 rounded-xl border ${s.border} ${s.bg} mb-3`}>
...
export default function PortalExceptions() {
    ...
    return (<div className="portal-root" style={{ background: 'var(--p-bg)' }}>
      ...
      <div className="max-w-2xl mx-auto px-4 pt-6 pb-12">
        ...
        {!loading && !errorMsg && (<>
            {/* Summary */}
            {exceptions.length > 0 && (<div className="flex gap-4 mb-6 text-sm">
            ...
            {exceptions.length === 0 && (<div className="flex flex-col items-center justify-center py-20">
