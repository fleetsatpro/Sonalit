...
const authCheck=()=>{if(!getAccessToken()&&!useAuthStore.getState().user)throw redirect({to:'/login',search:{redirect:window.location.pathname+window.location.search}})};
...
const aiDecisionsAliasRoute=createRoute({getParentRoute:()=>authRoute,path:'/ai-decisions',component:lazyRouteComponent(()=>import('./pages/AIDecision.js'))});
...
const identitySecurityRoute=createRoute({getParentRoute:()=>authRoute,path:'/identity',component:lazyRouteComponent(()=>import('./pages/IdentitySecurity.js'))});
