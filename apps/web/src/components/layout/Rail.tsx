...
import {
  ...
  Container, Lock, Navigation, Building2, Megaphone, ShieldCheck,
  type LucideIcon,
} from 'lucide-react';
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/signal-health',  icon: RadioTower,    label: 'Signal Integrity' },
  ...
  },
  {
    ...
    hue: '255,122,0',
    items: [
      { path: '/cds',              icon: LayoutDashboard, label: 'CDS Dashboard' },
      { path: '/cds/shipments',    icon: Package,         label: 'Shipments' },
      { path: '/cds/live',         icon: Navigation,      label: 'Live Tracking' },
      { path: '/cds/containers',   icon: Container,       label: 'Containers' },
      { path: '/cds/locks',        icon: Lock,            label: 'E-Locks' },
      { path: '/cds/drivers',      icon: Users,           label: 'Drivers' },
      { path: '/cds/vehicles',     icon: Truck,           label: 'Vehicles' },
      { path: '/cds/transporters', icon: Building2,       label: 'Transporters' },
      { path: '/cds/customers',    icon: Users,           label: 'Customers' },
      { path: '/cds/delivery',     icon: Package,         label: 'Delivery Ops' },
      { path: '/cds/geofences',    icon: Map,             label: 'Geofences' },
      { path: '/cds/inbox',        icon: Bot,             label: 'AI Inbox' },
      { path: '/cds/incidents',    icon: AlertTriangle,   label: 'Incidents' },
      { path: '/cds/alerts',       icon: Megaphone,       label: 'Alerts' },
      { path: '/cds/reports',      icon: FileText,        label: 'Reports' },
      { path: '/cds/analytics',    icon: BarChart2,       label: 'Analytics' },
      { path: '/cds/documents',    icon: FileBarChart,    label: 'Documents' },
      { path: '/cds/audit',        icon: ShieldCheck,     label: 'Audit Logs' },
      { path: '/cds/settings',     icon: Settings,        label: 'Settings' },
    ],
  },
];
