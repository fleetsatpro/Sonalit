...
import type { Mode } from './geo';

// TUNABLE — relative vehicle size (fraction of R). See engine.ts.
export const VSIZE: Record<Mode, number> = { air: 0.048, sea: 0.058, road: 0.044 };

export function drawPlane(ctx: CanvasRenderingContext2D, s: number): void {
...
export function drawShip(ctx: CanvasRenderingContext2D, s: number): void {
  // hull
...
export function drawTruck(ctx: CanvasRenderingContext2D, s: number): void {
...
export function drawVehicle(ctx: CanvasRenderingContext2D, mode: Mode, s: number): void {
