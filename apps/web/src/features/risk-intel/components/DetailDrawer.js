...
const TABS = ['overview', 'analytics', 'convoys'];
export default function DetailDrawer({ zone, onClose, isMobile = false }) {
    ...
    return (<div style={drawerStyle}>
      ...
      <div style={{ flex: 1, overflowY: 'auto' }}>
        {tab === 'overview' && (<div style={{ padding: '16px' }}>
            {zone.why && (<div style={{ marginBottom: 14 }}>
            ...
            {zone.when_active && (<div style={{ marginBottom: 14, padding: '8px 12px', background: 'rgba(255,255,255,.03)', borderRadius: 6 }}>
            ...
            {zone.precaution && (<div style={{ padding: '10px 12px', background: 'rgba(240,180,41,.06)', border: '1px solid rgba(240,180,41,.18)', borderRadius: 6 }}>
            ...
            {zone.tags?.length > 0 && (<div style={{ marginTop: 12, display: 'flex', flexWrap: 'wrap', gap: 5 }}>
