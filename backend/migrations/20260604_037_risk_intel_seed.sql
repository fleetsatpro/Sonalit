...
BEGIN
  ...
  -- zone_type CHECK: ('conflict','theft_hotspot','flood','road_closed','customs','checkpoint','restricted','no_go')
  -- risk_level CHECK: ('low','medium','high','critical','no_go')
  ...
  -- AFRICA
  (v_org_id, 'AF-MOG', 'Mogadishu Corridor', 'conflict', 'africa', 'high',
  ...
  (v_org_id, 'AF-NIG', 'Niger Delta Transit Zone', 'conflict', 'africa', 'high',
  ...
  (v_org_id, 'AF-SAH', 'Sahel Corridor (Mali-Niger)', 'conflict', 'africa', 'high',
  ...
  (v_org_id, 'AF-ETH', 'Afar Region Access Road', 'conflict', 'africa', 'medium',
  ...
  -- ASIA
  (v_org_id, 'AS-KHY', 'Khyber Pass Corridor', 'conflict', 'asia', 'high',
  ...
  (v_org_id, 'AS-MYA', 'Myanmar Central Corridor', 'conflict', 'asia', 'high',
  ...
  (v_org_id, 'AS-AFG', 'Kabul-Kandahar Highway', 'conflict', 'asia', 'medium',
  ...
  -- MIDEAST
  (v_org_id, 'ME-YEM', 'Marib-Sanaa Supply Route', 'conflict', 'mideast', 'high',
  ...
  (v_org_id, 'ME-IRQ', 'Baghdad Southern Belt', 'checkpoint', 'mideast', 'medium',
  ...
  -- EUROPE
  (v_org_id, 'EU-UKR', 'Eastern Ukraine Supply Line', 'conflict', 'europe', 'high',
  ...
  -- AMERICAS
  (v_org_id, 'AM-MEX', 'Tamaulipas Corridor', 'theft_hotspot', 'americas', 'high',
  ...
  (v_org_id, 'AM-COL', 'Uraba-Cordoba Axis', 'conflict', 'americas', 'medium',
   'Antioquia-Cordoba, Colombia', 'FARC-EMC and Clan del Golfo presence causing selective road access and extortion.',
  ...
  -- OCEANIA
  (v_org_id, 'OC-PNG', 'Highlands Highway, PNG', 'theft_hotspot', 'oceania', 'low',
