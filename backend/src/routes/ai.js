...
- Use get_world_context for mission-specific spatial questions. It is the canonical spatial source for convoy/vehicle position, route/corridor state, nearby incidents, risk zones, checkpoints, weather, external movement, relationships, events, freshness, provenance, uncertainty, and evidence. Never invent spatial facts that are not present in its result.
